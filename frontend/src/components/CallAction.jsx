...
export const CallAction = () => {
  return (
    ...
    <button className='bg-sky-600 hover:bg-sky-700 hover:shadow hover:shadow-blue-300 transition-all duration-150 text-white py-3 rounded font-bold text-xl w-56 '>Sign up for free</button>
  </div>
  )
}
