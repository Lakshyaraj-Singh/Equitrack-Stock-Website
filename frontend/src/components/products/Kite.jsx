...
export const Kite = () => {
  return (
   ...
   <LeftReveal duration={0.8} ><LeftSide imgs="./varsity.png" title="Varsity mobile" para="An easy to grasp, collection of stock market lessons with in-depth coverage and illustrations. Content is broken down into bite-size cards to help you learn on the go."/>
    </LeftReveal> 
    <hr />
    </div>
