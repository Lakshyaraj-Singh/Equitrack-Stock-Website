        ...
        <div className="bg-white w-[40%] mb-20 shadow-2xl shadow-black">
                ...
                <div className="flex flex-col gap-5 w-full items-center p-3">
                    ...
                    <div className="flex justify-between rounded-2xl  bg-blue-100 w-full  p-3">
                        ...
                        <div className=" flex gap-2 flex-col "><h1 className="font-extrabold text-2xl">{/*{stock.symbol}  */}{stock.name}</h1>  <p className="text-sm text-gray-700">Apple.Inc</p> <p className="text-xs text-gray-600">You Own 1 shares @$182.5 avg</p></div>
                  ...
                  {/* quantity of stock */}
                   <div className="w-full ">
                    ...
                    <input className="bg-gray-100 w-full pl-2 rounded-md" type="number" min={1} value={1}   name="qty" id="qty" />
                    <p className="text-xs text-gray-700 ">available shares 1</p>
                   </div>
